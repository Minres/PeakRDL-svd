...
from peakrdl_svd import SVDExporter
...
class SVDTestCase(unittest.TestCase):
    ...
    def export(self, node, file):
        svd = SVDExporter()
        svd.export(node, file, component_name="my_thing")
    ...
    def get_schema_path(self):
        ...
        return os.path.join(this_dir, "schema/svd.xsd")
